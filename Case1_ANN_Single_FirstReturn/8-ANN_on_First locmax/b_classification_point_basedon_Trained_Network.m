...
First_LocMax_Data_Net(:,5:7)=[];   %%%% choon network bar asase 11 vizhegi amozesh dideh 
...
First_LocMax_Data(:,8)=classes_Net;  %%%% classes be matrix avalie attach shodand
...
First_LocMax_ANN_Classes(:,:,8)=classification_Map;    %%%% haman matrix avalie ast faghat classification map be an ezafeh shode
...
% mishavand
  segment=First_LocMax_ANN_Classes(:,:,5);
  bin=First_LocMax(:,:,4);
  bin(bin>0)=1;
 for i=1:139
     i
